...
class ClientHandler(threading.Thread):
	...
	def logged(self, username):
		...
		while True:
			self.send(" \nWhat do you want to do? (message/ls/change_password/logout/delete_account)")  # menu for logged user
	...
	def message(self):
		...
		if encryption_type == 1:
			...
			print("Decrypted-Message : ", k.decrypt(enc_msg))
			...
			print("Decrypted-Message : ", enc_aes.decrypt(encrypted_message,key))
